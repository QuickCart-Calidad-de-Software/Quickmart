...
import DashboardView from "@/app/dashboard/seller/_components/DashboardView";
import InventoryView from "@/app/dashboard/seller/_components/InventoryView";
import OrdersView from "@/app/dashboard/seller/_components/OrdersView";
import SettingsView from "@/app/dashboard/seller/_components/SettingsView";
      ...
      >
        <nav className="flex flex-col gap-2 flex-1">
          ...
          <button
            ...
            style={
              activeSection !== "Pedidos" ? { color: "var(--foreground)" } : {}
            }
          >
            <svg
              className="w-5 h-5"
          ...
          <button
            ...
            style={
              activeSection !== "Settings" ? { color: "var(--foreground)" } : {}
            }
          >
            <svg
              className="w-5 h-5"
