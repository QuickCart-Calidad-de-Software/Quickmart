...
export default function ShoppingCart({
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl z-50 flex flex-col animate-slide-in-right border-l border-neutral-200">
        {/* Header - Minimal */}
        <div className="flex items-center justify-between p-8 border-b border-neutral-200">
          <div className="flex items-center gap-4">
            ...
            <span className="badge bg-neutral-900 text-white text-xs">
              {items.length}
            </span>
          </div>
          <button
            onClick={onClose}
            className="p-2 hover:bg-neutral-100 rounded-sm transition-all duration-300"
          >
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-6">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center px-6">
              <div className="w-20 h-20 bg-neutral-100 rounded-sm flex items-center justify-center mb-8">
                <ShoppingBag className="w-10 h-10 text-neutral-400" />
              </div>
              <h3 className="text-xl font-light text-neutral-900 mb-3 uppercase tracking-wide">
                Your cart is empty
              </h3>
              ...
              >
                <div className="flex gap-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 card p-1">
                        ...
                        <button
                          ...
                          className="p-1.5 hover:bg-slate-100 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-rose-50 rounded-xl transition-all duration-200 self-start h-fit"
                  >
        ...
        {items.length > 0 && (
          <div className="border-t border-neutral-200 p-8 space-y-6 bg-neutral-50">
            {/* Free Shipping Notice */}
            {shipping > 0 && subtotal < 500 && (
              <div className="flex items-center gap-3 text-sm bg-white text-neutral-700 p-4 rounded-sm border border-neutral-200">
            ...
            {shipping === 0 && (
              <div className="flex items-center gap-3 text-sm bg-neutral-900 text-white p-4 rounded-sm font-light uppercase tracking-wider">
                <Truck className="w-4 h-4 flex-shrink-0" />
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="flex justify-between text-neutral-600">
                ...
                <span className={shipping === 0 ? 'font-normal text-neutral-900' : 'font-light'}>
                  {shipping === 0 ? 'FREE' : `$${shipping.toLocaleString('es-MX', { minimumFractionDigits: 2 })}`}
                </span>
              </div>
              <div className="flex justify-between text-xl font-light pt-6 border-t border-neutral-200">
                <span className="text-neutral-900 uppercase tracking-wider">Total:</span>
            ...
            <button
              onClick={onCheckout}
              className="w-full py-4 text-sm font-normal bg-neutral-900 hover:bg-neutral-800 text-white rounded-sm transition-all duration-300 flex items-center justify-center gap-3 group uppercase tracking-widest border border-neutral-900"
            >
              Checkout
