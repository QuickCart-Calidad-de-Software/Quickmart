  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative p-2 hover:bg-neutral-100 dark:hover:bg-neutral-900 rounded-sm transition-all duration-300"
      >
        <Bell className="w-5 h-5 text-neutral-700 dark:text-neutral-300" />
        {unreadCount > 0 && (
          <span className="absolute top-1 right-1 w-4 h-4 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 text-[10px] font-normal rounded-sm flex items-center justify-center">
            {unreadCount}
          </span>
        )}
      </button>
