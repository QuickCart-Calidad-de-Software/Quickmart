...
export default function InventoryView({ searchQuery }: InventoryViewProps) {
  ...
  const mockProducts: Product[] = [
    {
      ...
      description: "Taladro de impacto de 20V con batería de litio de larga duración",
    ...
    },
    {
      ...
      description: "Laptop profesional con procesador Intel Core i7 de 11ª generación",
    ...
    },
    {
      id: 3,
      title: "iPhone 14 Pro",
      description: "Smartphone de última generación con cámara profesional de 48MP",
    ...
    },
    {
      ...
      description: "Kit de destornillador eléctrico con 50 puntas intercambiables",
      category: "Herramientas Eléctricas",
      price: "$79.99",
      stock: 52,
      image: "🔩"
  ...
  const getStockStatus = (stock: number) => {
    if (stock > 30) return { text: "Alto Stock", color: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400" };
    if (stock > 10) return { text: "Stock Medio", color: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400" };
    return { text: "Stock Bajo", color: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400" };
  };
          ...
          return (
            ...
            >
              ...
              <div className="p-4 space-y-3">
                ...
                {/* Title */}
                <h3 className="text-lg font-semibold line-clamp-1" style={{ color: "var(--foreground)" }}>
                  {product.title}
                </h3>
                ...
                <div className="flex gap-2 pt-2">
                  <button className="flex-1 px-3 py-2 border rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors"
                    style={{
                      borderColor: "var(--border-color)",
