...
export default function SettingsView() {
  ...
  const [profile, setProfile] = useState<SellerProfile>({
    ...
    zipCode: "03100",
    country: "México",
    description: "Vendedor especializado en productos electrónicos, herramientas y accesorios de alta calidad con más de 10 años de experiencia en el mercado."
  });
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <div 
            className="w-24 h-24 rounded-full flex items-center justify-center text-4xl font-bold text-white bg-gradient-to-br from-green-400 to-green-600"
          >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              type="text"
              value={isEditing ? tempProfile.businessName : profile.businessName}
